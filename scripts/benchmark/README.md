...
| ------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `kb_ignore_mode`          | `code`    | Indexes source and project configuration files; use `none` to keep the normal project inventory.                                                                          |
...
| `plan_todo_mode`          | `compact` | Keeps planning overhead low during long automated runs.                                                                                                                   |
