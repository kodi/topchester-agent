...
export const taskTool = defineTool({
  name: "task",
  description:
    "Delegate read-only file/search/git research to a child agent. Do not use for shell commands, bash, Python/Node scripts, validators, edits, writes, or other execution work.",
  prompt:
